...
public class OpenEphyraServer extends AbstractHandler {
	...
	protected void initFactoid() {
		...
		System.out.println("************* this is initFactoid() **************");
	...
	protected Result[] runPipeline(AnalyzedQuestion aq, int maxAnswers,
		...
		System.out.println("************* this is runPipeline(aq,ma,ab) **************");
		...
		p.println(Arrays.toString(results));
		p.close();
		// System.out.println();
	...
	public Result[] askFactoid(String question, int maxAnswers,
							   float absThresh) throws IOException{
		System.out.println("************* this is askFactoid(aq,ma,ab) **************");
	 ...
	 */
	public Result askFactoid(String question) throws IOException{
		System.out.println("************* this is askFactoid(q) **************");
	 ...
	 * @return array of results
	 */
	public Result[] askList(String question, float relThresh) throws IOException{
		...
		System.out.println("************* this is askList(aq,ma) **************");
